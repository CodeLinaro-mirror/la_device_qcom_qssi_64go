...
FAILED_FILEPATHS_WHITELIST = {
    ...
    "vendor/qcom/proprietary/prebuilt_ASAN/target/product/qssi_64go/prebuilt.mk",
    ...
    "vendor/qcom/proprietary/prebuilt_grease/target/product/qssi_64go/prebuilt.mk",
    ...
    "vendor/qcom/proprietary/prebuilt_HY11/target/product/qssi_64go/prebuilt.mk",
    ...
    "vendor/qcom/proprietary/prebuilt_HY22/target/product/qssi_64go/prebuilt.mk",
...
OVERRIDE_WHITELIST = {
    "device/qcom/qssi_64go/qssi_64go.mk",
    "device/qcom/qssi_64go/qssi_64go_whitelist.mk",
}

SOONG_WHITELIST = {
    "device/qcom/qssi_64go/base.mk",
    "vendor/qcom/opensource/commonsys/display/config/display-product-commonsys.mk",
