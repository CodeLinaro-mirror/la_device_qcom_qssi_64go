...
DEVICE_PACKAGE_OVERLAYS += device/qcom/qssi_64go/overlay-go/device
PRODUCT_PACKAGE_OVERLAYS += device/qcom/qssi_64go/overlay-go/product
endif
...
VENDOR_QTI_PLATFORM := qssi_64go
VENDOR_QTI_DEVICE := qssi_64go
...
$(call inherit-product, device/qcom/qssi_64go/common64.mk)
...
TARGET_SYSTEM_PROP += device/qcom/qssi_64go/system.prop
...
DEVICE_FRAMEWORK_MANIFEST_FILE := device/qcom/qssi_64go/framework_manifest.xml
...
PRODUCT_COPY_FILES += \
    device/qcom/qssi_64go/init.qcom.testscripts.sh:$(TARGET_COPY_OUT_PRODUCT)/etc/init.qcom.testscripts.sh
endif

PRODUCT_COPY_FILES += \
    device/qcom/qssi_64go/public.libraries.product-qti.txt:$(TARGET_COPY_OUT_PRODUCT)/etc/public.libraries-qti.txt

# copy system_ext specific whitelisted libraries to system_ext/etc
PRODUCT_COPY_FILES += \
    device/qcom/qssi_64go/public.libraries.system_ext-qti.txt:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/public.libraries-qti.txt
...
# Include mainline components and qssi_64go whitelist
ifeq (true,$(call math_gt_or_eq,$(SHIPPING_API_LEVEL),29))
  $(call inherit-product, device/qcom/qssi_64go/qssi_64go_whitelist.mk)
